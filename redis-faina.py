...
class StatCounter(object):
    ...
    def __init__(self, prefix_delim=':', redis_version=2.6):
        ...
        self.full_kyedict = defaultdict(int)    # add full command
        self.times = []
        self._cached_sorts = {}
        self.start_ts = None
        self.last_ts = None
    ...
    def print_stats(self):
        ...
        self._pretty_print(self._top_n(self.commands), 'Top Commands', percentages = True) # add full command
        self._pretty_print(self._top_n(self.full_kyedict), 'Top Full Command', percentages=True)
    ...
    def process_input(self, input):
        for line in input:
            ...
            full_command = '%s %s' % (command, key)
            self.full_kyedict[full_command] += 1
